    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
            ...
            <li class="active"><a href="{{route('posts.index')}}"><i class="fa fa-circle-o"></i> Home</a></li>
            ...
            <li><a href="{{route('role.index')}}"><i class="fa fa-circle-o"></i>Add Roles</a></li>
            <li><a href="{{route('users.index')}}"><i class="fa fa-circle-o"></i>All Users</a></li>
            <li><a href="{{route('permission.index')}}"><i class="fa fa-circle-o"></i>Add Permissions</a></li>
